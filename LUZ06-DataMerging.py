...
path = 'C:\\Users\\y_mus\\OneDrive - Hochschule Luzern\\HSLU\\Thesis\\Patient_raw_data\\Participant_6'
...
df1 = pd.read_csv('AppleWatchData/LUZ06_jun16_jun19.csv') #weekly data 1 
df2 = pd.read_csv('AppleWatchData/LUZ06_jun20_jun26.csv') #weekly data 2
...
# loading cgm data
cgm_df = cgm_preprocess('LUZ 06 Dexcom Daten.csv')
##################################################################################################################################
...
df_joined.to_csv('LUZ06_watch_cgm_data.csv')
