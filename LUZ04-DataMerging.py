...
path = 'C:\\Users\\y_mus\\OneDrive - Hochschule Luzern\\HSLU\\Thesis\\Patient_raw_data\\Participant_4'
...
df1 = fetch_data_from_file('AppleWatchData/WeeklyData/LUZ04_may26_jun01.json') #weekly data 1 
df2 = fetch_data_from_file('AppleWatchData/WeeklyData/LUZ04_may29_jun04.json') #weekly data 2
df3 = fetch_data_from_file('AppleWatchData/LUZ04_lastday_jun05.json') #last day data

# subsetting the first two days only, the rest of the data is present in the second file
df1 = df1[df1.index < '2023-05-29'] 

# subsetting the last day only
df3 = df3[df3.index > '2023-06-05']
...
# loading cgm data
cgm_df = cgm_preprocess('LUZ 04 Dexcom Daten.csv')
##################################################################################################################################
...
df_joined.to_csv('LUZ04_watch_cgm_data.csv')
