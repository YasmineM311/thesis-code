...
start_date = '2023-05-25 14:00:00'
path = 'C:\\Users\\y_mus\\OneDrive - Hochschule Luzern\\HSLU\\Thesis\\Patient_raw_data\\Participant_3'
...
df1 = fetch_data_from_file('AppleWatchData/WeeklyData/LUZ03_may25_may31.json') #weekly data 1 
df2 = fetch_data_from_file('AppleWatchData/WeeklyData/LUZ03_may28_jun03.json') #weekly data 2
df3 = fetch_data_from_file('AppleWatchData/LUZ03_lastday_jun04.json') #last day data

# subsetting the first two days only, the rest of the data is present in the second file
df1 = df1[df1.index < '2023-05-28'] 

# subsetting the last day only
df3 = df3[df3.index > '2023-06-04']
...
# loading cgm data
cgm_df = cgm_preprocess('LUZ 03 Dexcom Daten.csv')
##################################################################################################################################
...
df_joined.to_csv('LUZ03_watch_cgm_data.csv')
